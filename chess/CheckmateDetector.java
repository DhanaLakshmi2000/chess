...
public class CheckmateDetector {
    ...
    private boolean canBlock(List<Piece> threats, 
        ...
        if (threats.size() == 1) {
        	// JOptionPane.showMessageDialog(gameWindow,"check for black","Alert",JOptionPane.WARNING_MESSAGE); 
    ...
    public boolean testMove(Piece p, Square sq) {
        ...
        if (p.getColor() == 0 && blackInCheck()) {
        	...
        	JOptionPane.showMessageDialog(gameWindow,"check for white","Alert",JOptionPane.WARNING_MESSAGE);
        	movetest = false;
        }
